...
class ProductRepository {
    ...
    static create(product) {
      ...
      `);
            ...
            if (info.changes > 0) {
                AuditLogRepository_1.AuditLogRepository.write({ action: 'PRODUCT_CREATE', details: `Product ${id} created` });
            }
    ...
    `);
        ...
        if (info.changes > 0) {
            AuditLogRepository_1.AuditLogRepository.write({ action: 'PRODUCT_UPDATE', details: `Product ${product.id} updated` });
        }
    ...
    static deactivate(id) {
        ...
        if (info.changes > 0) {
            AuditLogRepository_1.AuditLogRepository.write({ action: 'PRODUCT_DEACTIVATE', details: `Product ${id} deactivated` });
        }
        return info.changes > 0;
    }
